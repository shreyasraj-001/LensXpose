        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2 flex flex-col sm:flex-row items-center justify-center gap-5 mt-6">
            ...
            <a
              ...
              className="flex items-center gap-2.5 font-body text-[11px] tracking-[0.14em] uppercase px-8 py-4 border border-[#25D366]/35 text-[#25D366]/80 hover:border-[#25D366]/70 hover:text-[#25D366] transition-all duration-300 hover-target"
            >
